...
<h3>Item   : <span style="color:#0000FF"><?php echo $item_info->telugu_name. " - " .$item_info->item_name ;?></span></h3>
  <a href="<?php echo site_url('item_balances');?>" class='no-print'><b>Go back</b></a>  <a href="javascript:window.print();" class='btn btn-info pull-right no-print'><b>Print</b></a>  <br><br>
