            ...
            <div class="box-body">
			  ...
			  <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                ...
                <tbody>
				 ...
				 <a href='<?php echo site_url();?>opening_balance/admin/listitems/<?php echo $school->school_id;?>'> 
                 ...
                 <td>  <a href='<?php echo site_url();?>opening_balance/admin/listitems/<?php echo $school->school_id;?>'>Open</a> </td><?php }  ?>
                </tr>
