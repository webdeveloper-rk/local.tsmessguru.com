...
<h3><?php echo $school_name."-".$item_details->telugu_name ." - ".$item_details->item_name; ?> Report</h3>
...
<div class="box">
            ...
            <div class="box-body">
               ...
               <div><a class="btn btn-info pull-right no-print" href='<?php echo site_url('report_itemwise_admin/itemreport/'.$download_link);?>'>Download Report</a></div>
			
			  <a class="btn btn-info pull-right no-print"  href='<?php echo site_url('report_itemwise_admin');?>'>Go Back</a>  <A class="btn btn-info pull-right no-print" href='javascript:window.print();'>Print</a>
			  
			  
			  <a class="btn btn-info pull-right no-print"  href='<?php echo site_url('report_itemwise_admin/recalculate/'.$encoded_data);?>'>Recalculate Balances</a> 
			 <a class="btn btn-info pull-right no-print"  href='<?php echo site_url('report_itemwise_admin/start_recalculate/'.$encoded_data);?>'>Recalculate from starting</a>
			  </div>
			  <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
				...
				aria-label="Engine version: activate to sort column ascending" style="width: 106px;">Consumption Qty</th> 
				 ...
				 <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" 
				aria-label="Engine version: activate to sort column ascending" style="width: 106px;">Consumption Avg Price(KG/Litre)</th> 
				
				
				
					<th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" 
				aria-label="Engine version: activate to sort column ascending" style="width: 106px;">Attendance</th> 
 
 	<th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" 
				aria-label="Engine version: activate to sort column ascending" style="width: 106px;">Avg used quantity in kgs</th>
 <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" 
				...
				<td class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" 
				aria-label="Engine version: activate to sort column ascending" style="widtd: 106px;"><?php echo  number_format($item->consumed_total/$item->consumed_qty,2);?></td> 
				
				 
				<td class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" 
				aria-label="Engine version: activate to sort column ascending" style="widtd: 106px;"><?php echo $attendence[$item->entry_date];?></td> 
				
				<td class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" 
				aria-label="Engine version: activate to sort column ascending" style="widtd: 106px;"><?php  if( $attendence[$item->entry_date]==0) { echo "0.00";}else {
					echo  round($item->consumed_qty/$attendence[$item->entry_date] ,3);
				} ;?></td> 
				  <td class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" 
